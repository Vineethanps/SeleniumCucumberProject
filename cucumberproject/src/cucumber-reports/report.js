...
formatter.match({
  "location": "LoginOfDemowebshop.url_of_demowebshop(String)"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "LoginOfDemowebshop.user_enters_as_username(String)"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "LoginOfDemowebshop.user_enters_as_password(String)"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "LoginOfDemowebshop.user_is_in_webshop(String)"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "LoginOfDemowebshop.admin_of_the_test_me_app_enters(DataTable)"
});
formatter.result({
  "status": "passed"
});
